...
function initLifeMap(){
  ...
  root.addEventListener("click", (e)=>{
    ...
    if(btn.hasAttribute("data-left")){
      moveGoal(btn.getAttribute("data-d"), btn.getAttribute("data-h"), btn.getAttribute("data-left"), "sooner");
      return;
    }
    if(btn.hasAttribute("data-right")){
      moveGoal(btn.getAttribute("data-d"), btn.getAttribute("data-h"), btn.getAttribute("data-right"), "later");
    }
  });
