const BUILD_VERSION = "v43-test-guarded-wide";
...
document.addEventListener("DOMContentLoaded", ()=>{
  ...
  else if(page==="morningmap" || page==="home") initMorningMap();
  ...
  container.innerHTML = `
    ...
    <div class="card" style="margin-top:14px">
      <div class="row" style="justify-content:space-between; align-items:center">
        ...
        <div class="small muted">Jump to a page without thinking.</div>
      </div>
      <div class="nav" style="margin-top:10px">
        <a data-nav href="quick-capture.html">⚡ Quick Capture</a>
        <a data-nav href="thread-registry.html">Thread Registry</a>
        <a data-nav href="strategic-life-map.html">Strategic Life Map</a>
        <a data-nav href="90-day-income-map.html">90‑Day Income Map</a>
        <a data-nav href="how-this-works.html">How This Works</a>
      </div>
    </div>
